...
public class NodeUtil {
     ...
     * @return All the keyword modifiers applied onto a declaration. Note this is
     *         modifiers actually in the source code AST. This means a declaration
     *         might have some default properties not seen in the modifiers. Java
     *         also supports user-specified annotation modifiers. These are not
     *         returned.
     */
    public static List<Modifier> getKeywordModsFromDeclaration(BodyDeclaration decl) {
        ...
        var kwArgs = getKeywordsFromModifierList((List<IExtendedModifier>) decl.modifiers());
        return kwArgs;
    }
